    ...
    return (
        <div className='flex items-center justify-center w-screen h-screen p-5'>
            <div className="flex w-full md:w-10/12 max-w-[1000px] h-[90vh] border-2 rounded-lg p-2">
                ...
                <div className='hidden md:block w-full md:w-1/2 rounded-lg bg-purple-600 overflow-hidden relative'>
                    
                    <div className='absolute w-[200px] h-[200px] transform rounded-xl rotate-[14deg] -bottom-[5rem] -left-32 bg-purple-500'></div>
                    <div className='absolute w-[200px] h-[200px] transform rounded-xl rotate-[14deg] -top-[5rem] -right-20 bg-purple-500'></div>
